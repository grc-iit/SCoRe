...
int main(){
	...
	ReverseTrieQueueNodeConfig rt_config_1 (rtqn_key_1, url, {config_1},  {}, 1);
...
//  ReverseTrieQueueNodeConfig rt_config_2 (rtqn_key_2, url, {config_2},  1, 0); //TODO: was missing the hostname, replaced by url and the {1} is wrong
