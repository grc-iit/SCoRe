...
do
  ...
  "${EXEC_PATH}"/build/publish_test 1 "${num_messages}" "${default_message_size}" >> ./results/subscribe_publish_test &
...
do
  ...
  "${EXEC_PATH}"/build/publish_test 1 "${num_messages}" "${size_message}" >> ./results/subscribe_publish_test_size &
...
do
  ...
  "${EXEC_PATH}"/build/publish_test 1 "${num_messages}" "${default_message_size}" >> ./results/subscribe_publish_test_redis &
